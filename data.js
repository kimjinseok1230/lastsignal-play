import {normalizeLook,DEFAULT_LOOK} from './cosmetics.js?v=cat19';
import {EXTRA_CATS,collectionMeta} from './roster.js?v=cat19';
...
export function createMeta(){return {version:VERSION,cosmetics:{...DEFAULT_LOOK},credits:0,base:{},runs:0,wins:0,bestTime:0,bestKills:0,totalKills:0,history:[],collection:collectionMeta(),settings:{sound:true,volume:.36,musicVolume:.55,effectsVolume:.8,shake:true,particles:true}};}
