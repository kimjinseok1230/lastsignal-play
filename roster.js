...
export const ACTIVE_SKILLS={
 runner:{name:'발바닥 쾅',desc:'주변 적을 밀쳐내고 강한 충격파를 냅니다.',cd:16},
 engineer:{name:'깃털 함정',desc:'주변에 깃털 폭탄 6개를 설치합니다. 접근한 적에게 폭발합니다.',cd:18},
 warden:{name:'철벽 식빵',desc:'2초간 무적이 되고 가까운 적을 밀쳐냅니다.',cd:22},
 spider:{name:'거미줄 감옥',desc:'주변 적을 5초간 느리게 하고 거미줄 피해를 줍니다.',cd:18},
 frost:{name:'급속 냉각',desc:'주변 적에게 5초 냉기와 둔화를 걸고 얼음 피해를 줍니다.',cd:19},
 ninja:{name:'그림자 베기',desc:'조준 방향의 넓은 부채꼴을 강하게 벱니다. 0.7초간 무적입니다.',cd:14},
 chef:{name:'불맛 볶음',desc:'넓은 범위에 피해를 주고 5초간 화상을 남깁니다.',cd:20},
 nurse:{name:'응급 츄르',desc:'최대 체력의 25%를 회복하고 1초간 무적이 됩니다.',cd:26},
 spark:{name:'연쇄 방전',desc:'최대 8마리에게 이어지는 번개를 방출합니다.',cd:18},
 wizard:{name:'별빛 소나기',desc:'사방으로 관통하는 별 16개를 발사합니다.',cd:17},
 astro:{name:'간식 블랙홀',desc:'조준 방향에 4초간 적을 끌어당기며 피해를 주는 중력장을 만듭니다.',cd:22},
 moon:{name:'초승달 춤',desc:'조준 방향으로 관통 후 돌아오는 초승달 5개를 발사합니다.',cd:18}
};
