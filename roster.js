...
export const PASSIVES={
 ...
 spark:{name:'충전 발바닥',desc:'적 5마리를 처치할 때마다 전용 스킬의 남은 재사용 시간이 1초 줄어듭니다.'},
...
export const ACTIVE_SKILLS={
 runner:{name:'츄르 질주',desc:'4초간 이동 속도 +60%. 달리는 경로에 폭발하는 잔상을 남깁니다.',cd:16},
 engineer:{name:'깃털 포탑',desc:'현재 위치에 8초간 적을 자동 조준하는 깃털 포탑을 설치합니다.',cd:20},
 warden:{name:'반격 식빵',desc:'5초간 최대 체력 45%만큼 피해를 흡수하고 흡수량의 2배로 주변 적에게 반격합니다.',cd:22},
 spider:{name:'거미줄 둥지',desc:'조준 방향에 6초간 거미줄 지대를 설치합니다. 들어온 적을 묶고 지속 피해를 줍니다.',cd:20},
 frost:{name:'빙결 창',desc:'전방으로 관통 얼음창 5개를 발사합니다. 맞은 적을 2초간 얼립니다. 보스는 0.35초.',cd:18},
 ninja:{name:'그림자 관통',desc:'조준 방향으로 순간 이동하며 이동 경로의 적을 벱니다. 0.65초간 무적입니다.',cd:16},
 chef:{name:'불맛 조리',desc:'3초간 조준 방향으로 화염을 뿜습니다. 방향을 돌려 적을 쓸어 담고 화상을 남깁니다.',cd:20},
 nurse:{name:'츄르 진료소',desc:'7초간 유지되는 회복 지대를 설치합니다. 안에 있으면 초당 체력 5%를 회복하고 탄환을 지웁니다.',cd:26},
 spark:{name:'시한 방전',desc:'가까운 적 최대 6마리에 전기를 심습니다. 1.2초 후 표식이 폭발하며 주변에도 피해를 줍니다.',cd:18},
 wizard:{name:'별빛 사역마',desc:'7초간 주변을 도는 사역마 3개를 소환합니다. 사역마가 적을 자동 조준해 별을 쏩니다.',cd:22},
 astro:{name:'간식 블랙홀',desc:'조준 방향에 4초간 적을 끌어당기며 피해를 주는 중력장을 만듭니다.',cd:22},
 moon:{name:'초승달 춤',desc:'초승달 5개가 적을 관통한 뒤 자신에게 돌아옵니다. 이동으로 돌아오는 궤적을 바꿀 수 있습니다.',cd:18}
};
